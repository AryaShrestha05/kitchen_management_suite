...
class Recipe(Base):
    ...
    RecipeID = Column(Integer, primary_key = True, autoincrement=True) # needs to be changed once we figure out format of RecipeID

    RecipeBody = Column(Text) # change based on what body of recipe requires.
